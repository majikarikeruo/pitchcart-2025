...
export type SlideEvaluation = z.infer<typeof SlideEvaluationSchema>;
...
export type StructureSimulationStep = z.infer<typeof StructureSimulationStepSchema>;
...
export type StructureSimulation = z.infer<typeof StructureSimulationSchema>;


// ---------- Main Response Schema & Type ----------
...
export const validateAndRepairJson = <T>(json: any, schema: z.ZodType<T>, logContext: string = 'validate'): T | null => {
  ...
  console.error(`[schema:${logContext}] Zod validation failed after all repair attempts. Errors:`, (secondParse as any).error.issues);
  try {
...
export function fallbackPersona(persona_id: string): PersonaOutput {
  return {
    persona_id,
...
export function makeResponse(personas: PersonaOutput[], consensus: Consensus, slides_struct?: SlideStruct[]): AnalysisResponse {
